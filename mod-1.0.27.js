...
(function () {
  ...
  function showHiddenEvents(){
    ...
    try {
      ...
      /* dispatch event de ActivityInfoView.upadteActivityBtns() goi lai */
      try {
        ...
        if (d && typeof d.dispatchEvent === "function") {
          d.dispatchEvent("MainUIView_delay");
          d.dispatchEvent("ModuleOpen_CheckFinish");
          d.dispatchEvent("activity_update"); /* trigger ActivityInfoView.upadteActivityBtns() */
          L("UI refresh events dispatched");
        }
      } catch(e2){ L("ui refresh err "+e2); }
