...
(function () {
  ...
  function installMenu(){
    ...
    function ensureMenu(){
      ...
      addToggleRow(pageBasic, "Lực chiến 100tr (ảo)", "fakeCombat", y);
  ...
  var n=0, okS=false, okA=false, okE=false, okI=false, okG=false, okD=false, okF=false;
  ...
  function tick(){
    ...
    if (n===1 || n===40 || (okS&&okA&&okE&&n%20===0)) { L("tick "+n+" subHp="+okS+" ad="+okA+" event="+okE+" ingoreAd="+okI+" grade="+okG+" devour="+okD+" fake="+okF); flush(); }
    if (n<1200 && (!okS || !okA || !okE || !okI || !okG || !okD || !okF)) later(tick);
  }
  installMenu();
  later(tick);
  later(autoTick);
