      ...
      if (vm && typeof vm.reqVoucherTaskGetTaskReward === "function" && !vm.__jm_vad) {
        vm.reqVoucherTaskGetTaskReward = function(recordId){
          ...
          if (RPC && typeof RPC.send === "function") {
            RPC.send("Activity_VoucherTask_GetTaskReward", { recordId: recordId, useItem: true }, function(){}, function(e){ L("voucher reward err "+e); });
            L("voucher claim recordId=" + recordId + " useItem=true");
          }
        };
        vm.__jm_vad = true;
