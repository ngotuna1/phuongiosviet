...
(function () {
  ...
  function showHiddenEvents(){
    ...
    try {
      ...
      /* hook upadteActivityBtns tren prototype de bo qua verify check vi~nh vien */
      try {
        var Proto = getExport("ActivityMap", "ActivityMap");
        /* khong can lam gi them - isVerifyApp da patch o tren */
      } catch(e2){}
